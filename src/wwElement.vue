        ...
        <template v-if="richEditor">
            <div class="ww-rich-text__menu native-menu" v-if="!hideMenu && !content.customMenu" :style="menuStyles">
                ...
                <button type="button" class="ww-rich-text__menu-item" @click="setTextAlign('left')"
                    ...
                    v-if="menu.alignLeft" title="Align left">
                    <TextAlignStart class="icon" />
                </button>
                ...
                <button type="button" class="ww-rich-text__menu-item" @click="setTextAlign('center')"
                    ...
                    v-if="menu.alignCenter" title="Align center">
                    <TextAlignCenter class="icon" />
                </button>
                ...
                <button type="button" class="ww-rich-text__menu-item" @click="setTextAlign('right')"
                    ...
                    v-if="menu.alignRight" title="Align right">
                    <TextAlignEnd class="icon" />
                </button>
                ...
                <button type="button" class="ww-rich-text__menu-item" @click="setTextAlign('justify')"
                    ...
                    v-if="menu.alignJustify" title="Align justify">
                    <TextAlignJustify class="icon" />
                </button>
                ...
                <button type="button" class="ww-rich-text__menu-item" @click="toggleBulletList"
                    ...
                    v-if="menu.bulletList" title="Bullet list">
                    <ListIcon class="icon" />
                </button>
                <button type="button" class="ww-rich-text__menu-item" @click="toggleOrderedList"
                    ...
                    v-if="menu.orderedList" title="Ordered list">
                ...
                <button type="button" class="ww-rich-text__menu-item" @click="toggleBlockquote"
                    ...
                    v-if="menu.blockquote" title="Blockquote">
                    <QuoteIcon class="icon" />
                </button>

                <!-- Math -->
                <button type="button" class="ww-rich-text__menu-item" @click="insertInlineMath()"
                    :disabled="!isEditable" v-if="menu.inlineMath" title="Inline math">
                    <SquareFunction class="icon" />
                </button>
                <button type="button" class="ww-rich-text__menu-item" @click="insertBlockMath()" :disabled="!isEditable"
                    v-if="menu.blockMath" title="Block math">
                    <SigmaIcon class="icon" />
                </button>
